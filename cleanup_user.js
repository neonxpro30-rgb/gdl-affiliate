...
async function cleanup() {
    console.log('Searching for drolexpro@gmail.com...');
    const snapshot = await db.collection('users').where('email', '==', 'drolexpro@gmail.com').get();
    ...
    snapshot.forEach(doc => {
        ...
        console.log(`Marked for deletion: ${doc.id} (${doc.data().email})`);
    });
