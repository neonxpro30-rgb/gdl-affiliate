...
if (!admin.apps.length) {
    // Hardcoded credentials to fix Netlify build issue
    // TODO: Move back to environment variables after successful deploy
    ...
    admin.initializeApp({
        ...
        storageBucket: "gdl-database-b32f4.appspot.com"
    });
}
